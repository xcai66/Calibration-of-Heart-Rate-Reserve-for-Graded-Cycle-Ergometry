...
Relative to uncalibrated HRR, the locked function reduced complete-test VO2-reserve mean absolute error by 1.07 percentage points in the temporal holdout and participant-level error by 1.38 points in the external task. Exact temporal 10% VO2-reserve-band agreement increased by 8.8 percentage points. The manuscript also reports the less favorable but important finding that the nonlinear function did not outperform development-fitted linear calibration for primary temporal VO2-reserve. Intensity-band and endpoint-exclusion analyses further distinguish the benefit of general group calibration from any unsupported claim of high-intensity curvature superiority.
